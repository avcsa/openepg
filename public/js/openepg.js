...
module.exports=require('WCKnMU');
},{}],"WCKnMU":[function(require,module,exports){
...
},{"backbone":"2/1CFr","jquery":"sCyUNK","underscore":"2eoIad"}],"2/1CFr":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"underscore":"2eoIad"}],"backbone":[function(require,module,exports){
module.exports=require('2/1CFr');
},{}],"sCyUNK":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('sCyUNK');
},{}],"2eoIad":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//     Underscore.js 1.5.2
...
module.exports=require('2eoIad');
},{}]},{},["WCKnMU","2/1CFr","sCyUNK","2eoIad"])
;
...
},{"./collections/events":2,"./collections/services":3,"./controller":4,"./models/event":6,"./models/server":7,"./models/service":8,"./router":9}],2:[function(require,module,exports){
...
},{"../models/event":6}],3:[function(require,module,exports){
var Backbone     = require('backbone')
,   ServiceModel = require('../models/service')
;
...
},{"../models/service":8}],4:[function(require,module,exports){
var Marionette         = require('backbone.marionette')
...
},{"./views/add_event":10,"./views/add_service":11,"./views/event_details":12,"./views/events":13,"./views/home":14,"./views/service_details":15,"./views/services":16}],5:[function(require,module,exports){
var App = require('./app');
var epg = new App();
epg.start();
...
},{"../../templates/add_service.hbs":18}],12:[function(require,module,exports){
var Marionette = require('backbone.marionette')
;
...
},{"../../templates/event_details.hbs":19}],13:[function(require,module,exports){
var Marionette = require('backbone.marionette')
;
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack2)
    + "\" readonly /><br />\n<div class=\"form-title\">Duration</div>\n<input class=\"form-field\" type=\"time\" step=\"1\" name=\"duration\" id=\"duration\" value=\"";
  ...
  buffer += escapeExpression(stack2)
    + "\" readonly /><br />\n</td><td>\n<div class=\"form-title\">Title</div>\n<input class=\"form-field\" type=\"text\" name=\"title\" id=\"title\" value=\"";
  if (stack2 = helpers.title) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.title; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
    + "\" readonly /><br />\n<div class=\"form-title\">Synopsis</div>\n<textarea class=\"form-field\" cols=\"40\" rows=\"3\" name=\"synopsis\" id=\"synopsis\" readonly >";
  if (stack2 = helpers.synopsis) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.synopsis; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
    + "</textarea><br />\n</td></tr></table>\n<div class=\"submit-container\">\n    <a href=\"#\" class=\"submit-button\">Delete Event</a>\n</div>";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"form-title\"><h2>Server Status</h2></div>\n<table><tr><td>\n<div class=\"form-title\">Started: ";
  if (stack1 = helpers.serverStarted) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.serverStarted; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</div>\n<div class=\"form-title\">Last Update Attempt: ";
  if (stack1 = helpers.lastUpdateAttempt) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.lastUpdateAttempt; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</div>\n</td><td>\n<div class=\"form-title\">Last EIT updated: ";
  if (stack1 = helpers.lastEitUpdated) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.lastEitUpdated; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</div>\n<div class=\"form-title\">Last Carousel updated: ";
  if (stack1 = helpers.lastCarouselUpdated) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.lastCarouselUpdated; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "</div>\n</td></tr></table>\n<div class=\"submit-container\">\n    <a href=\"#\" class=\"submit-button\">Update EIT</a>\n</div>";
  return buffer;
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"form-title\"><h2>Service Details</h2></div>\n<table><tr><td>\n<div class=\"form-title\">PID</div>\n<input class=\"form-field\" type=\"number\" min=\"1\" name=\"pid\" id=\"pid\" value=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\" readonly/><br />\n<div class=\"form-title\">Signal ID</div>\n<input class=\"form-field\" type=\"number\" min=\"1\" name=\"signalId\" id=\"signalId\" value=\"";
  if (stack1 = helpers.signalId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.signalId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" readonly/><br />\n<div class=\"form-title\">Original Network ID</div>\n<input class=\"form-field\" type=\"number\" min=\"1\" name=\"originalNetworkId\" id=\"originalNetworkId\" value=\"";
  if (stack1 = helpers.originalNetworkId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.originalNetworkId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" readonly/><br />\n</td><td>\n<div class=\"form-title\">Transport Stream ID</div>\n<input class=\"form-field\" type=\"number\" min=\"1\" name=\"transportStreamId\" id=\"transportStreamId\" value=\"";
  if (stack1 = helpers.transportStreamId) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.transportStreamId; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\" readonly/><br />\n<div class=\"form-title\">Comment</div>\n<input class=\"form-field\" type=\"text\" name=\"comment\" id=\"comment\" value=\"";
  ...
  buffer += escapeExpression(stack1)
    + "\" readonly/><br />\n</td></tr></table>\n<div class=\"submit-container\">\n    <a href=\"#\" class=\"submit-button\">Delete Service</a>\n</div>";
  return buffer;
  });
